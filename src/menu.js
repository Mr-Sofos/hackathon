...
import FigureModule from "./modules/figure.modules";
...
export default class ContextMenu extends Menu {
  ...
  add() {
    const customMessageElement = new CustomMessage(
      "message",
      "Вызвать сообщение"
    );
    const soundElement = new Sound("sound", "Случайный звук");
    const figureModuleObject = new FigureModule("figure", "Случайная фигура");
  }
}
